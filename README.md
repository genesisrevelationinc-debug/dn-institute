...
We have launched a new challenge to build and deploy an AI product using the [Product Development Kit](https://github.com/1712n/product-kit-template). For details, see [Issue #1](https://github.com/1712n/dn-institute/issues/1). 🌰🌰🌰
### General rules
