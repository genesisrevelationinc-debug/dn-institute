...
- The QA bot for article checks has been migrated to a Cloudflare Worker. You can find the worker code in the `workers` directory.
- The worker is triggered by webhooks from GitHub Actions.
