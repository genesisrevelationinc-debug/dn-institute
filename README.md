...
## 🌱 AI Product: Cyber Threat Intelligence Brief

We are building an AI-powered product that generates weekly intelligence briefs on emerging cyber threats. This product leverages GitHub Models to provide actionable insights and is integrated with social media for real-time updates. 🌰🌰🌰
### General rules
