...
We have migrated our QA bot to a Cloudflare Worker for improved efficiency and scalability. The worker is triggered by webhooks and checks the quality of articles in pull requests.
