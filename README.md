...
We are excited to announce a new challenge where participants can build and deploy their own AI product using the [Product Development Kit](https://github.com/1712n/product-kit-template). Dive into unique use cases, play with variables and prompts, and leverage [GitHub Models](https://docs.github.com/en/github-models/use-github-models) for extra functionality. 🌰🌰🌰
